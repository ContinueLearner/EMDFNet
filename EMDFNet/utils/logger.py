...
class StreamToLoguru:
    ...
    def isatty(self):
        ...
        # https://github.com/Megvii-BaseDetection/EMDFNet/issues/1437 might be raised
...
class WandbLogger(object):
    ...
    https://docs.wandb.ai/guides/integrations/other/EMDFNet
    """
    def __init__(self,
                 project=None,
                 name=None,
        ...
        from EMDFNet.data.datasets import VOCDetection
